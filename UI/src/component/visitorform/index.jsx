    ...
    validate=()=>{
       ...
       handlesubmit=async (event)=>{
        ...
        if (isvalid){
           ...
           axios.post(`${config.apiUrl}/visitor`
      ...
      handleInputChange=(event)=>{
         ...
         this.setState({checkouttime: x.value})
         console.log(this.state.name,this.state.email,this.state.phone,this.state.checkouttime);
      }
    render(){
        return(
        ...
        <div className="container">
          ...
          <label htmlFor="phone no"><b>PhoneNumber</b></label>
          ...
          <label htmlFor="CheckOut Time"><b>Checkout Time</b></label>
          <input type="time"  id="myTime"   onChange={this.handleInputChange} name="checkouttime" required />
          

          
          <div className="clearfix">
            <Link type="button" to="/"  className="btn btn-danger mg">Cancel</Link>
            <button type="submit" className="btn btn-success mg">Check In</button>
          </div>
        </div>
      </form>
        )
